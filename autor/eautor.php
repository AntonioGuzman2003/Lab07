...
<body>
    ...
    <div class="card-body">
        <form name="formAutor" method="post" action="editar_autor.php">
        <input type="text" class="form-control" value="<?php echo $alum['id'] ?>"  name="id" >
            <div class="form-group">
                <label>Nombres:</label>
                <input type="text" class="form-control" value="<?php echo $alum['nombres'] ?>" placeholder="Nombre del Autor" name="nombres" >
            </div>
            <div class="form-group">
        ...
        <br>
        <div>
            <a href="../autor/autor.php" class="btn btn-primary">Volver a Inicio</a>
        </div>
        <?php
